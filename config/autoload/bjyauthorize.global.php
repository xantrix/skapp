...
return [
    'bjyauthorize' => [
        ...
        */
         ...
         */
		/*https://github.com/bjyoungblood/BjyAuthorize/issues/126
		...
		*/
        ...
        'role_providers' => [
            ...
            /* Default:here, 'guest' and 'user are defined as top-level roles, with
             * 'admin' inheriting from user
             * Current: guest -> user -> {other_roles} -> admin
             */
         ...
         * NOTE: check guards rules as normal "resources"
         * with $this->isAllowed('route/route/name')[all_privs] or $this->isAllowed('controller/controller-name','action')
         */
        'guards' => [
